...
@section('title','Office Fund List')
@push('css')
...
<div class="main-content">
    <div class="page-content">
        <div wire:initial-data='{"id":"TGKgpMRW41xeKn8100rt","name":"backend.office-fund","redirectTo":false,"locale":"en","events":[],"eventQueue":[],"dispatchQueue":[],"data":{"payment_method":null,"from_account":null,"to_account":null,"fund_txn_pin":null,"fund_amount":null,"username":null,"transfer_amount":null,"transfer_txn_pin":null,"username_name":null,"available_balance":"0.00"},"children":[],"checksum":"d169bbfe2368079b15b8e4dcc904cf6366b7e3e9b04de90b72f789cbfafe8db1"}'
            wire:id="TGKgpMRW41xeKn8100rt">
            <!-- start page title -->
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-flex align-items-center justify-content-between">
                        <h4 class="page-title mb-0 font-size-18">Office Fund List</h4>
                        ...
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Office Fund List</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-body">
                            <button class="btn btn-primary mb-2 float-right newTopup"><i class="fa fa-plus"></i> Add
                                Office Fund</button>
                            <button class="btn btn-info mb-2 mr-2 float-right topupTransfer"><i class="fa fa-plus"></i>
                                Office Fund Transfer</button>
                            ...
                            <form wire:submit.prevent="fundTransfer">
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" class="btn btn-sm btn-primary waves-effect waves-light"
                                        wire:loading.attr="disabled" wire:target="fundTransfer">Transfer Now</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <form wire:submit.prevent="addFundRequest">
                            <div class="modal-header">
                                <h4 class="modal-title">Add Office Fund</h4>
                            ...
                            <div class="modal-footer">
                                <button type="button" class="btn btn-sm btn-default waves-effect"
                                    data-dismiss="modal">Close</button>
                                <button type="submit" class="btn btn-sm btn-primary waves-effect waves-light"
                                    wire:target="addFundRequest" wire:loading.attr="disabled">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
...
<script>
    $(document).ready(function () {
        ...
        var dataTable = $('#TopupTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: 'https://myglobaloneway.com/data/office-fund',
            columns: [{
                    title: 'SL',
                    data: 'id',
                    name: 'id'
                ...
                {
                    title: 'Office Fund Flow',
                    data: 'flow',
                    name: 'flow'
                },
                {
                    title: 'Office Fund Amount',
                    data: 'amount',
                    name: 'amount'
                },
                {
